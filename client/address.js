console.log('[CLIENT] Loading address.js ...');
...
AddressController = AppController.extend({
  ...
  data: function () {
    ...
    return {
      formDoc: function () { return Test.findOne({'_id': Router.current().params.id}); }
    };
    //return {};
  },
...
AutoForm.hooks({
  formUpdate: {
    formToDoc: function (doc) {
      console.log('formUpdate formToDoc', doc);
      return doc;
    },
    docToForm: function (doc) {
      console.log('formUpdate docToForm', doc);
      return doc;
    }
  }
});
